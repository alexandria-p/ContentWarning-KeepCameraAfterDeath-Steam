...
public class SurfaceNetworkHandlerPatch
{
    ...
    private static void SurfaceNetworkHandler_InitSurface(On.SurfaceNetworkHandler.orig_InitSurface orig, SurfaceNetworkHandler self)
    {
        ...
        {            
            ...
            {
                Debug.Log($"{MyPluginInfo.PLUGIN_NAME} v{MyPluginInfo.PLUGIN_VERSION}: Found backed-up camera footage");
            ...
            {
                Debug.Log($"{MyPluginInfo.PLUGIN_NAME} v{MyPluginInfo.PLUGIN_VERSION}: Could not find camera footage to restore");
